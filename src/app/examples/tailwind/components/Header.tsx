      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            <Link href="/examples/tailwind">
              <a className="text-base font-medium text-gray-500 hover:text-gray-900">탐색하기</a>
            </Link>
            <Link href="/examples/tailwind/mint">
              <a className="text-base font-medium text-gray-500 hover:text-gray-900">발행하기</a>
            </Link>
            <Link href="/examples/tailwind/profile">
              <a className="text-base font-medium text-gray-500 hover:text-gray-900">마이페이지</a>
            </Link>
          </Popover.Group>
